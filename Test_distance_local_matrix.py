...
list_n_traj = list(range(100, 1100, 100))#list(range(100, 1100, 100))
list_n_psi_added = list(range(100, 1100, 100))#list(range(100, 1100, 100))
...
# Saving the arrays
np.save('Distances_new.npy', Distances)
np.save('Norms_new.npy', Norms)
