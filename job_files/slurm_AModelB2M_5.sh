...
#SBATCH --output=output_AModelB2M_5.log         # Standard output log
#SBATCH --error=error_AModelB2M_5.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelB2M_5.json AModelB2M yes
