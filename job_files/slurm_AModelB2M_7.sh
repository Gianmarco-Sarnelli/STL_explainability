...
#SBATCH --output=output_AModelB2M_7.log         # Standard output log
#SBATCH --error=error_AModelB2M_7.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelB2M_7.json AModelB2M yes
