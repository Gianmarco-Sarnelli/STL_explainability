...
#SBATCH --output=output_AModelG2M_0.log         # Standard output log
#SBATCH --error=error_AModelG2M_0.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelG2M_0.json AModelG2M yes
