...
#SBATCH --output=output_AModelG2M_1.log         # Standard output log
#SBATCH --error=error_AModelG2M_1.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelG2M_1.json AModelG2M yes
