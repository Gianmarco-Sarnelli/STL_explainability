...
#SBATCH --output=output_AModelH2M_1.log         # Standard output log
#SBATCH --error=error_AModelH2M_1.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelH2M_1.json AModelH2M yes
