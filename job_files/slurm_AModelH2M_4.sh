...
#SBATCH --output=output_AModelH2M_4.log         # Standard output log
#SBATCH --error=error_AModelH2M_4.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelH2M_4.json AModelH2M yes
