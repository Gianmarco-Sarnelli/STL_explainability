...
#SBATCH --output=output_AModelM2M_1.log         # Standard output log
#SBATCH --error=error_AModelM2M_1.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelM2M_1.json AModelM2M yes
