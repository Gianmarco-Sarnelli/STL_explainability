...
#SBATCH --output=output_AModelM2M_7.log         # Standard output log
#SBATCH --error=error_AModelM2M_7.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelM2M_7.json AModelM2M yes
