...
#SBATCH --output=output_AModelS2M_1.log         # Standard output log
#SBATCH --error=error_AModelS2M_1.log           # Standard error log
...
python3 Test_model.py job_files/params_AModelS2M_1.json AModelS2M yes
