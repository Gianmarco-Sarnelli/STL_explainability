...
#SBATCH --output=output_B2B_11.log         # Standard output log
#SBATCH --error=error_B2B_11.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_B2B_11.json B2B 
