...
#SBATCH --output=output_B2E_10.log         # Standard output log
#SBATCH --error=error_B2E_10.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_B2E_10.json B2E 
