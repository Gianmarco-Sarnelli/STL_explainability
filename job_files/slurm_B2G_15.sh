...
#SBATCH --output=output_B2G_15.log         # Standard output log
#SBATCH --error=error_B2G_15.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_B2G_15.json B2G 
