...
#SBATCH --output=output_B2M_17.log         # Standard output log
#SBATCH --error=error_B2M_17.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_B2M_17.json B2M 
