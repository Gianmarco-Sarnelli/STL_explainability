...
#SBATCH --output=output_BaseModelM2M_3.log         # Standard output log
#SBATCH --error=error_BaseModelM2M_3.log           # Standard error log
...
python3 Test_model.py job_files/params_BaseModelM2M_3.json BaseModelM2M yes
