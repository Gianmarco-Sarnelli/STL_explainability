...
#SBATCH --output=output_E2E_12.log         # Standard output log
#SBATCH --error=error_E2E_12.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_E2E_12.json E2E 
