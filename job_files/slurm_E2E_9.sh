...
#SBATCH --output=output_E2E_9.log         # Standard output log
#SBATCH --error=error_E2E_9.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_E2E_9.json E2E 
