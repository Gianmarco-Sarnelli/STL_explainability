...
#SBATCH --output=output_E2G_16.log         # Standard output log
#SBATCH --error=error_E2G_16.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_E2G_16.json E2G 
