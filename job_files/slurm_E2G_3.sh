...
#SBATCH --output=output_E2G_3.log         # Standard output log
#SBATCH --error=error_E2G_3.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_E2G_3.json E2G 
