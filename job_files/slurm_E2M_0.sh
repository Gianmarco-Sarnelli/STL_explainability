...
#SBATCH --output=output_E2M_0.log         # Standard output log
#SBATCH --error=error_E2M_0.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_E2M_0.json E2M 
