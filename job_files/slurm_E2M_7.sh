...
#SBATCH --output=output_E2M_7.log         # Standard output log
#SBATCH --error=error_E2M_7.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_E2M_7.json E2M 
