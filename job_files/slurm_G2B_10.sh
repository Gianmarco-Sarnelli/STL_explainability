...
#SBATCH --output=output_G2B_10.log         # Standard output log
#SBATCH --error=error_G2B_10.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_G2B_10.json G2B 
