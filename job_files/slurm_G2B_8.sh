...
#SBATCH --output=output_G2B_8.log         # Standard output log
#SBATCH --error=error_G2B_8.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_G2B_8.json G2B 
