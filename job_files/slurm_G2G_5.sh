...
#SBATCH --output=output_G2G_5.log         # Standard output log
#SBATCH --error=error_G2G_5.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_G2G_5.json G2G 
