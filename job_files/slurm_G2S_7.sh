...
#SBATCH --output=output_G2S_7.log         # Standard output log
#SBATCH --error=error_G2S_7.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_G2S_7.json G2S 
