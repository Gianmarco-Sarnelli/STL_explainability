...
#SBATCH --output=output_GeneralTestOther_M2M_3.log         # Standard output log
#SBATCH --error=error_GeneralTestOther_M2M_3.log           # Standard error log
...
python3 Test_model.py job_files/params_GeneralTestOther_M2M_3.json GeneralTestOther_M2M yes
