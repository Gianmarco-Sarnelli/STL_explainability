...
#SBATCH --output=output_GeneralTestOther_S2M_2.log         # Standard output log
#SBATCH --error=error_GeneralTestOther_S2M_2.log           # Standard error log
...
python3 Test_model.py job_files/params_GeneralTestOther_S2M_2.json GeneralTestOther_S2M yes
