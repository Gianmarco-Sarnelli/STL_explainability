...
#SBATCH --output=output_GeneralTestOther_T2M_5.log         # Standard output log
#SBATCH --error=error_GeneralTestOther_T2M_5.log           # Standard error log
...
python3 Test_model.py job_files/params_GeneralTestOther_T2M_5.json GeneralTestOther_T2M yes
