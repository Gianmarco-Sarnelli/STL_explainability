...
#SBATCH --output=output_GeneralTestmu0_M2M_10.log         # Standard output log
#SBATCH --error=error_GeneralTestmu0_M2M_10.log           # Standard error log
...
python3 Test_model.py job_files/params_GeneralTestmu0_M2M_10.json GeneralTestmu0_M2M yes
