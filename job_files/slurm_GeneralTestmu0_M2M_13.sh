...
#SBATCH --output=output_GeneralTestmu0_M2M_13.log         # Standard output log
#SBATCH --error=error_GeneralTestmu0_M2M_13.log           # Standard error log
...
python3 Test_model.py job_files/params_GeneralTestmu0_M2M_13.json GeneralTestmu0_M2M yes
