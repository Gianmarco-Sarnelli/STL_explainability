...
#SBATCH --output=output_M2E_1.log         # Standard output log
#SBATCH --error=error_M2E_1.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_M2E_1.json M2E 
