...
#SBATCH --output=output_M2G_11.log         # Standard output log
#SBATCH --error=error_M2G_11.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_M2G_11.json M2G 
