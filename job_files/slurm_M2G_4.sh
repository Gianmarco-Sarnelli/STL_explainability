...
#SBATCH --output=output_M2G_4.log         # Standard output log
#SBATCH --error=error_M2G_4.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_M2G_4.json M2G 
