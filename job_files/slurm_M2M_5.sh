...
#SBATCH --output=output_M2M_5.log         # Standard output log
#SBATCH --error=error_M2M_5.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_M2M_5.json M2M 
