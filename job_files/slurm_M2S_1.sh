...
#SBATCH --output=output_M2S_1.log         # Standard output log
#SBATCH --error=error_M2S_1.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_M2S_1.json M2S 
