...
#SBATCH --output=output_NEWweirdMU0_E2B_36.log         # Standard output log
#SBATCH --error=error_NEWweirdMU0_E2B_36.log           # Standard error log
...
python3 Test_distance.py job_files/params_NEWweirdMU0_E2B_36.json NEWweirdMU0_E2B yes
