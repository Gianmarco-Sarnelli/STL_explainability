...
#SBATCH --output=output_NEWweirdMU0_M2B_9.log         # Standard output log
#SBATCH --error=error_NEWweirdMU0_M2B_9.log           # Standard error log
...
python3 Test_distance.py job_files/params_NEWweirdMU0_M2B_9.json NEWweirdMU0_M2B yes
