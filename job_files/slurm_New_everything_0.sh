...
#SBATCH --output=output_0.log         # Standard output log
#SBATCH --error=error_0.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_0.json New_everything 
