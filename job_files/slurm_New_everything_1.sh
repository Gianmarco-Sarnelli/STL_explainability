...
#SBATCH --output=output_1.log         # Standard output log
#SBATCH --error=error_1.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_1.json New_everything 
