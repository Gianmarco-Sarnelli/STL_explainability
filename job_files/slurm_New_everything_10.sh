...
#SBATCH --output=output_10.log         # Standard output log
#SBATCH --error=error_10.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_10.json New_everything 
