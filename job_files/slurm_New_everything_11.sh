...
#SBATCH --output=output_11.log         # Standard output log
#SBATCH --error=error_11.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_11.json New_everything 
