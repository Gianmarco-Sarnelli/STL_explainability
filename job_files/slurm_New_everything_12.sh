...
#SBATCH --output=output_12.log         # Standard output log
#SBATCH --error=error_12.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_12.json New_everything 
