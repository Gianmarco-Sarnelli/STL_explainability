...
#SBATCH --output=output_14.log         # Standard output log
#SBATCH --error=error_14.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_14.json New_everything 
