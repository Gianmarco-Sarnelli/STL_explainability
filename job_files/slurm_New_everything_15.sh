...
#SBATCH --output=output_15.log         # Standard output log
#SBATCH --error=error_15.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_15.json New_everything 
