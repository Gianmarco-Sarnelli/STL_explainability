...
#SBATCH --output=output_16.log         # Standard output log
#SBATCH --error=error_16.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_16.json New_everything 
