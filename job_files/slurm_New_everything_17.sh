...
#SBATCH --output=output_17.log         # Standard output log
#SBATCH --error=error_17.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_17.json New_everything 
