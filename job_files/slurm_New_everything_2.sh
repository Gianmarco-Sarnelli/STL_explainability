...
#SBATCH --output=output_2.log         # Standard output log
#SBATCH --error=error_2.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_2.json New_everything 
