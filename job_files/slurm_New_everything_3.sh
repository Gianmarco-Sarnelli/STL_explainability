...
#SBATCH --output=output_3.log         # Standard output log
#SBATCH --error=error_3.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_3.json New_everything 
