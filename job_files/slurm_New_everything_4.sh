...
#SBATCH --output=output_4.log         # Standard output log
#SBATCH --error=error_4.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_4.json New_everything 
