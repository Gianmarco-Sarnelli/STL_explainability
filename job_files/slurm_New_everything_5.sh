...
#SBATCH --output=output_5.log         # Standard output log
#SBATCH --error=error_5.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_5.json New_everything 
