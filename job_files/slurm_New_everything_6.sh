...
#SBATCH --output=output_6.log         # Standard output log
#SBATCH --error=error_6.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_6.json New_everything 
