...
#SBATCH --output=output_7.log         # Standard output log
#SBATCH --error=error_7.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_7.json New_everything 
