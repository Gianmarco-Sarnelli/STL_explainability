...
#SBATCH --output=output_8.log         # Standard output log
#SBATCH --error=error_8.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_8.json New_everything 
