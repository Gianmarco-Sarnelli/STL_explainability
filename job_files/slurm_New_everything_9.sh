...
#SBATCH --output=output_9.log         # Standard output log
#SBATCH --error=error_9.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_New_everything_9.json New_everything 
