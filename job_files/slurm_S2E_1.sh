...
#SBATCH --output=output_S2E_1.log         # Standard output log
#SBATCH --error=error_S2E_1.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_S2E_1.json S2E 
