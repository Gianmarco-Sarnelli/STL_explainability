...
#SBATCH --output=output_S2E_6.log         # Standard output log
#SBATCH --error=error_S2E_6.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_S2E_6.json S2E 
