...
#SBATCH --output=output_S2G_9.log         # Standard output log
#SBATCH --error=error_S2G_9.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_S2G_9.json S2G 
