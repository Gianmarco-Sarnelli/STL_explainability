...
#SBATCH --output=output_S2M_16.log         # Standard output log
#SBATCH --error=error_S2M_16.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_S2M_16.json S2M 
