...
#SBATCH --output=output_S2S_0.log         # Standard output log
#SBATCH --error=error_S2S_0.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_S2S_0.json S2S 
