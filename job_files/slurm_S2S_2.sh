...
#SBATCH --output=output_S2S_2.log         # Standard output log
#SBATCH --error=error_S2S_2.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_S2S_2.json S2S 
