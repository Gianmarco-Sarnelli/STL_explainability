...
#SBATCH --output=output_Weighted_B2M_5.log         # Standard output log
#SBATCH --error=error_Weighted_B2M_5.log           # Standard error log
...
python3 Test_model.py job_files/params_Weighted_B2M_5.json Weighted_B2M yes
