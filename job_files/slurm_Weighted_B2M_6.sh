...
#SBATCH --output=output_Weighted_B2M_6.log         # Standard output log
#SBATCH --error=error_Weighted_B2M_6.log           # Standard error log
...
python3 Test_model.py job_files/params_Weighted_B2M_6.json Weighted_B2M yes
