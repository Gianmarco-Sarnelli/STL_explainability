...
#SBATCH --output=output_Weighted_G2M_7.log         # Standard output log
#SBATCH --error=error_Weighted_G2M_7.log           # Standard error log
...
python3 Test_model.py job_files/params_Weighted_G2M_7.json Weighted_G2M yes
