...
#SBATCH --output=output_Weighted_H2M_1.log         # Standard output log
#SBATCH --error=error_Weighted_H2M_1.log           # Standard error log
...
python3 Test_model.py job_files/params_Weighted_H2M_1.json Weighted_H2M yes
