...
#SBATCH --output=output_Weighted_S2M_3.log         # Standard output log
#SBATCH --error=error_Weighted_S2M_3.log           # Standard error log
...
python3 Test_model.py job_files/params_Weighted_S2M_3.json Weighted_S2M yes
