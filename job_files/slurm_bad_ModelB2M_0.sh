...
#SBATCH --output=output_bad_ModelB2M_0.log         # Standard output log
#SBATCH --error=error_bad_ModelB2M_0.log           # Standard error log
...
python3 Test_model.py job_files/params_bad_ModelB2M_0.json bad_ModelB2M yes
