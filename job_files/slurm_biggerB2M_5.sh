...
#SBATCH --output=output_biggerB2M_5.log         # Standard output log
#SBATCH --error=error_biggerB2M_5.log           # Standard error log
...
python3 Test_model.py job_files/params_biggerB2M_5.json biggerB2M yes
