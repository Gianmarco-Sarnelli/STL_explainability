...
#SBATCH --output=output_biggerG2M_5.log         # Standard output log
#SBATCH --error=error_biggerG2M_5.log           # Standard error log
...
python3 Test_model.py job_files/params_biggerG2M_5.json biggerG2M yes
