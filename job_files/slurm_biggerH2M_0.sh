...
#SBATCH --output=output_biggerH2M_0.log         # Standard output log
#SBATCH --error=error_biggerH2M_0.log           # Standard error log
...
python3 Test_model.py job_files/params_biggerH2M_0.json biggerH2M yes
