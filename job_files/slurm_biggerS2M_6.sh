...
#SBATCH --output=output_biggerS2M_6.log         # Standard output log
#SBATCH --error=error_biggerS2M_6.log           # Standard error log
...
python3 Test_model.py job_files/params_biggerS2M_6.json biggerS2M yes
