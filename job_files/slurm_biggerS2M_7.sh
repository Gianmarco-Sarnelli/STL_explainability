...
#SBATCH --output=output_biggerS2M_7.log         # Standard output log
#SBATCH --error=error_biggerS2M_7.log           # Standard error log
...
python3 Test_model.py job_files/params_biggerS2M_7.json biggerS2M yes
