...
#SBATCH --output=output_focusMU0_E2B_19.log         # Standard output log
#SBATCH --error=error_focusMU0_E2B_19.log           # Standard error log
...
python3 Test_distance.py job_files/params_focusMU0_E2B_19.json focusMU0_E2B yes
