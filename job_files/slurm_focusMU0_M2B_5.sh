...
#SBATCH --output=output_focusMU0_M2B_5.log         # Standard output log
#SBATCH --error=error_focusMU0_M2B_5.log           # Standard error log
...
python3 Test_distance.py job_files/params_focusMU0_M2B_5.json focusMU0_M2B yes
