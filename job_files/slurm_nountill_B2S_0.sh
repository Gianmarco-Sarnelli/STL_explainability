...
#SBATCH --output=output_nountill_B2S_0.log         # Standard output log
#SBATCH --error=error_nountill_B2S_0.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_nountill_B2S_0.json nountill_B2S 
