...
#SBATCH --output=output_nountill_E2M_2.log         # Standard output log
#SBATCH --error=error_nountill_E2M_2.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_nountill_E2M_2.json nountill_E2M 
