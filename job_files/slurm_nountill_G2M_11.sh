...
#SBATCH --output=output_nountill_G2M_11.log         # Standard output log
#SBATCH --error=error_nountill_G2M_11.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_nountill_G2M_11.json nountill_G2M 
