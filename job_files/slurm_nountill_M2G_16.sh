...
#SBATCH --output=output_nountill_M2G_16.log         # Standard output log
#SBATCH --error=error_nountill_M2G_16.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_nountill_M2G_16.json nountill_M2G 
