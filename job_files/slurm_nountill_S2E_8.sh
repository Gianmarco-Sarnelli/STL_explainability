...
#SBATCH --output=output_nountill_S2E_8.log         # Standard output log
#SBATCH --error=error_nountill_S2E_8.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_nountill_S2E_8.json nountill_S2E 
