...
#SBATCH --output=output_onlytarget_pure_G2M_6.log         # Standard output log
#SBATCH --error=error_onlytarget_pure_G2M_6.log           # Standard error log
...
python3 Test_model.py job_files/params_onlytarget_pure_G2M_6.json onlytarget_pure_G2M yes
