...
#SBATCH --output=output_onlytarget_pure_H2M_8.log         # Standard output log
#SBATCH --error=error_onlytarget_pure_H2M_8.log           # Standard error log
...
python3 Test_model.py job_files/params_onlytarget_pure_H2M_8.json onlytarget_pure_H2M yes
