...
#SBATCH --output=output_onlytarget_pure_M2M_4.log         # Standard output log
#SBATCH --error=error_onlytarget_pure_M2M_4.log           # Standard error log
...
python3 Test_model.py job_files/params_onlytarget_pure_M2M_4.json onlytarget_pure_M2M yes
