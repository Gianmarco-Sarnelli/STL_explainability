...
#SBATCH --output=output_precomp_E2B_2.log         # Standard output log
#SBATCH --error=error_precomp_E2B_2.log           # Standard error log
...
python3 Test_distance.py job_files/params_precomp_E2B_2.json precomp_E2B yes
