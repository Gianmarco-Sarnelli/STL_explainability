...
#SBATCH --output=output_precomp_M2B_42.log         # Standard output log
#SBATCH --error=error_precomp_M2B_42.log           # Standard error log
...
python3 Test_distance.py job_files/params_precomp_M2B_42.json precomp_M2B yes
