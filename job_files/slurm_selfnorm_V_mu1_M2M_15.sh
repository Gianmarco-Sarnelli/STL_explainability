...
#SBATCH --output=output_selfnorm_V_mu1_M2M_15.log         # Standard output log
#SBATCH --error=error_selfnorm_V_mu1_M2M_15.log           # Standard error log
#SBATCH --get-user-env                       # Activating the environment

# Run the Python script
python3 Test_model.py job_files/params_selfnorm_V_mu1_M2M_15.json selfnorm_V_mu1_M2M yes
