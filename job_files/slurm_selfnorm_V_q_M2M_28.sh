...
#SBATCH --output=output_selfnorm_V_q_M2M_28.log         # Standard output log
#SBATCH --error=error_selfnorm_V_q_M2M_28.log           # Standard error log
...
python3 Test_model.py job_files/params_selfnorm_V_q_M2M_28.json selfnorm_V_q_M2M yes
