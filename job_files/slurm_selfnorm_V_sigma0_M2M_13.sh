...
#SBATCH --output=output_selfnorm_V_sigma0_M2M_13.log         # Standard output log
#SBATCH --error=error_selfnorm_V_sigma0_M2M_13.log           # Standard error log
#SBATCH --get-user-env                       # Activating the environment

# Run the Python script
python3 Test_model.py job_files/params_selfnorm_V_sigma0_M2M_13.json selfnorm_V_sigma0_M2M yes
