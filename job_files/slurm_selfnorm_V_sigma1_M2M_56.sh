...
#SBATCH --output=output_selfnorm_V_sigma1_M2M_56.log         # Standard output log
#SBATCH --error=error_selfnorm_V_sigma1_M2M_56.log           # Standard error log
...
python3 Test_model.py job_files/params_selfnorm_V_sigma1_M2M_56.json selfnorm_V_sigma1_M2M yes
