...
#SBATCH --output=output_selfnorm_pure_B2M_4.log         # Standard output log
#SBATCH --error=error_selfnorm_pure_B2M_4.log           # Standard error log
...
python3 Test_model.py job_files/params_selfnorm_pure_B2M_4.json selfnorm_pure_B2M yes
