...
#SBATCH --output=output_selfnorm_pure_H2M_2.log         # Standard output log
#SBATCH --error=error_selfnorm_pure_H2M_2.log           # Standard error log
...
python3 Test_model.py job_files/params_selfnorm_pure_H2M_2.json selfnorm_pure_H2M yes
