...
#SBATCH --output=output_simpleconvert_B2H_4.log         # Standard output log
#SBATCH --error=error_simpleconvert_B2H_4.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_B2H_4.json simpleconvert_B2H yes
