...
#SBATCH --output=output_simpleconvert_B2M_0.log         # Standard output log
#SBATCH --error=error_simpleconvert_B2M_0.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_B2M_0.json simpleconvert_B2M yes
