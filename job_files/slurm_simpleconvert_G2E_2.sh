...
#SBATCH --output=output_simpleconvert_G2E_2.log         # Standard output log
#SBATCH --error=error_simpleconvert_G2E_2.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_G2E_2.json simpleconvert_G2E yes
