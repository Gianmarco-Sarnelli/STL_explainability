...
#SBATCH --output=output_simpleconvert_H2H_1.log         # Standard output log
#SBATCH --error=error_simpleconvert_H2H_1.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_H2H_1.json simpleconvert_H2H yes
