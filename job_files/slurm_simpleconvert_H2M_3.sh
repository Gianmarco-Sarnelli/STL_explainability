...
#SBATCH --output=output_simpleconvert_H2M_3.log         # Standard output log
#SBATCH --error=error_simpleconvert_H2M_3.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_H2M_3.json simpleconvert_H2M yes
