...
#SBATCH --output=output_simpleconvert_J2H_2.log         # Standard output log
#SBATCH --error=error_simpleconvert_J2H_2.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_J2H_2.json simpleconvert_J2H yes
