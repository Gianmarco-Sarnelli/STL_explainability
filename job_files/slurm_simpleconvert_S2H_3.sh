...
#SBATCH --output=output_simpleconvert_S2H_3.log         # Standard output log
#SBATCH --error=error_simpleconvert_S2H_3.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_S2H_3.json simpleconvert_S2H yes
