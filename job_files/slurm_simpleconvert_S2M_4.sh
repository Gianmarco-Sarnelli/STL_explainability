...
#SBATCH --output=output_simpleconvert_S2M_4.log         # Standard output log
#SBATCH --error=error_simpleconvert_S2M_4.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_S2M_4.json simpleconvert_S2M yes
