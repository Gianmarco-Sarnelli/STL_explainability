...
#SBATCH --output=output_simpleconvert_T2E_4.log         # Standard output log
#SBATCH --error=error_simpleconvert_T2E_4.log           # Standard error log
...
python3 Test_distance.py job_files/params_simpleconvert_T2E_4.json simpleconvert_T2E yes
