...
#SBATCH --output=output_someMU0_E2B_24.log         # Standard output log
#SBATCH --error=error_someMU0_E2B_24.log           # Standard error log
...
python3 Test_distance.py job_files/params_someMU0_E2B_24.json someMU0_E2B yes
