...
#SBATCH --output=output_someMU0_M2B_37.log         # Standard output log
#SBATCH --error=error_someMU0_M2B_37.log           # Standard error log
...
python3 Test_distance.py job_files/params_someMU0_M2B_37.json someMU0_M2B yes
