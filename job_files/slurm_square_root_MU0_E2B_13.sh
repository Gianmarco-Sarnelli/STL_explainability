...
#SBATCH --output=output_square_root_MU0_E2B_13.log         # Standard output log
#SBATCH --error=error_square_root_MU0_E2B_13.log           # Standard error log
...
python3 Test_distance.py job_files/params_square_root_MU0_E2B_13.json square_root_MU0_E2B yes
