...
#SBATCH --output=output_square_root_MU0_M2B_22.log         # Standard output log
#SBATCH --error=error_square_root_MU0_M2B_22.log           # Standard error log
...
python3 Test_distance.py job_files/params_square_root_MU0_M2B_22.json square_root_MU0_M2B yes
