...
#SBATCH --output=output_squareroot_pure_G2M_6.log         # Standard output log
#SBATCH --error=error_squareroot_pure_G2M_6.log           # Standard error log
...
python3 Test_model.py job_files/params_squareroot_pure_G2M_6.json squareroot_pure_G2M yes
