...
#SBATCH --output=output_13.log         # Standard output log
#SBATCH --error=error_13.log           # Standard error log
...
python3 Test_distance_slurm.py job_files/params_true_formula_13.json true_formula 
