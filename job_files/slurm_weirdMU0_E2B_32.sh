...
#SBATCH --output=output_weirdMU0_E2B_32.log         # Standard output log
#SBATCH --error=error_weirdMU0_E2B_32.log           # Standard error log
...
python3 Test_distance.py job_files/params_weirdMU0_E2B_32.json weirdMU0_E2B yes
