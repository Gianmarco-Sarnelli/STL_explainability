...
#SBATCH --output=output_weirdMU0_M2B_18.log         # Standard output log
#SBATCH --error=error_weirdMU0_M2B_18.log           # Standard error log
...
python3 Test_distance.py job_files/params_weirdMU0_M2B_18.json weirdMU0_M2B yes
