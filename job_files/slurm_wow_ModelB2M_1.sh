...
#SBATCH --output=output_wow_ModelB2M_1.log         # Standard output log
#SBATCH --error=error_wow_ModelB2M_1.log           # Standard error log
...
python3 Test_model.py job_files/params_wow_ModelB2M_1.json wow_ModelB2M yes
