...
#SBATCH --output=output_wow_ModelB2M_3.log         # Standard output log
#SBATCH --error=error_wow_ModelB2M_3.log           # Standard error log
...
python3 Test_model.py job_files/params_wow_ModelB2M_3.json wow_ModelB2M yes
