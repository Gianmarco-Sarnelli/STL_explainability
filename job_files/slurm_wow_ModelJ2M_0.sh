...
#SBATCH --output=output_wow_ModelJ2M_0.log         # Standard output log
#SBATCH --error=error_wow_ModelJ2M_0.log           # Standard error log
...
python3 Test_model.py job_files/params_wow_ModelJ2M_0.json wow_ModelJ2M yes
