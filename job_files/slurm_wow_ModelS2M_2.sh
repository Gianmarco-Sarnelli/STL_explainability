...
#SBATCH --output=output_wow_ModelS2M_2.log         # Standard output log
#SBATCH --error=error_wow_ModelS2M_2.log           # Standard error log
...
python3 Test_model.py job_files/params_wow_ModelS2M_2.json wow_ModelS2M yes
